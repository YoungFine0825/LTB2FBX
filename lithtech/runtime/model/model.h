...
public:
	...
	inline ModelVert &operator=(const ModelVert &o)
	{
		m_Vec.x = o.m_Vec.x;
		m_Vec.y = o.m_Vec.y;
		m_Vec.z = o.m_Vec.z;

		m_Normal.x = o.m_Normal.x;
		m_Normal.y = o.m_Normal.y;
		m_Normal.z = o.m_Normal.z;

		m_Uv.tu = o.m_Uv.tu;
		m_Uv.tv = o.m_Uv.tv;

		m_NumBones = o.m_NumBones;

		m_Weights.m_iBone[0] = o.m_Weights.m_iBone[0];
		m_Weights.m_iBone[1] = o.m_Weights.m_iBone[1];
		m_Weights.m_iBone[2] = o.m_Weights.m_iBone[2];
		m_Weights.m_iBone[3] = o.m_Weights.m_iBone[3];

		m_Weights.m_fWeight[0] = o.m_Weights.m_fWeight[0];
		m_Weights.m_fWeight[1] = o.m_Weights.m_fWeight[1];
		m_Weights.m_fWeight[2] = o.m_Weights.m_fWeight[2];
		m_Weights.m_fWeight[3] = o.m_Weights.m_fWeight[3];
...
public:
	...
	inline ModelTri &operator=(const ModelTri &o)
	{
		m_Indices[0] = o.m_Indices[0];
		m_Indices[1] = o.m_Indices[1];
		m_Indices[2] = o.m_Indices[2];
...
public :
	...
	bool					Load_SkelMesh_RenderDirect(ILTStream &file, uint32 iVertCount, uint32 iPolyCount, uint32 iMaxBonesPerTri, uint32 iMaxBonesPerVert, uint8 bReIndexBones, uint32 (&StreamData)[4], uint8 bUseMatrixPalettes);
	bool					Load_SkelMesh_MatrixPalettes(ILTStream &file, uint32 iVertCount, uint32 iPolyCount, uint32 iMaxBonesPerTri, uint32 iMaxBonesPerVert, uint8 bReIndexBones, uint32 (&StreamData)[4], uint8 bUseMatrixPalettes);
...
public :
	...
	static CDIModelDrawable *CreateModelRenderObject( const char *name, uint32 type );
